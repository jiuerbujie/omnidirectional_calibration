...
"   multiCamCalib -nc 5 -pw 800 -ph 600 -ct 1 -nm 10 multi_camera.xml \n"
"\n"
...
int main(int argc, char** argv)
{
    ...
    const char* outputFilename = "multi-camera-resutl.xml";
    ...
    for (int i = 1; i < argc; ++i)
    {
        ...
        {
            if (sscanf( argv[++i], "%u", &cameraType) != 1 || (cameraType !=0 && cameraType !=1) )
            {
    ...
    multiCameraCalibration multiCalib(cameraType, nCamera, inputFilename, patternWidth, patternHeight, nMiniMatches);
    ...
    multiCalib.writeParameters("multicamera_params.xml");
}